...
class sqlite3_load_data:
    ...
    def load_iso_timezones(con:sqlite3.Connection,cur: sqlite3.Cursor) -> pl.DataFrame:
        """ """
        try:
            df = pl.read_database(
    ...
    def load_fb_weekly_rosters(con:sqlite3.Connection,cur: sqlite3.Cursor) -> pl.DataFrame:
        """ """
        df = pl.read_database(
    ...
    def load_fb_depth_charts(con:sqlite3.Connection,cur: sqlite3.Cursor) -> pl.DataFrame:
        """ """
        df = pl.read_database(
...
def test_sqlite3_load():
    ...
    try:
        ...
        con = sqlite3.connect(f"{home_dir}/.sdv_pbp/sdv_pbp_py.sqlite")
        cur = con.cursor()
    ## sqlite3.OperationalError if the file is inaccessable
