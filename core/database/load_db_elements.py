...
- Last Updated: 06/04/2024 02:15 PM EDT
        ...
        try:
            df = pl.read_database(
                ...
                schema_overrides={
                    ...
                    "yahoo_id": pl.String,
                    "rotowire_id": pl.String,
                    "pff_id": pl.String,
                    "pfr_id": pl.String,
                    "fantasy_data_id": pl.String,
    ...
    def load_fb_schedule(
        ...
        try:
            df = pl.read_database(
                ...
                infer_schema_length=1000,
                schema_overrides={
                    "game_is_in_progress": pl.Binary,
                    "game_is_finished": pl.Binary,
                    "season": pl.UInt16,
                    "game_id": pl.UInt64,
                    "league_id": pl.String,
                    ...
                    "pff_game_id": pl.UInt64,
                    "espn_game_id": pl.UInt64,
                    "ftn_game_id": pl.UInt64,
                    "football_db_game_id": pl.String,
                    "arenafan_game_id": pl.UInt64,
                    "away_days_rest": pl.UInt16,
                    "home_days_rest": pl.UInt16,
                    "is_neutral_site_game": pl.Binary,
                    "is_overtime_game": pl.Binary,
                    "is_divisional_game": pl.Binary,
                    "game_roof": pl.String,
                    "surface": pl.String,
                    "temp_f": pl.Float32,
                    "temp_c": pl.Float32,
