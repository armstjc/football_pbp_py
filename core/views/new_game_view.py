...
class NewGameView:
    """
    Allows one to create a new game within a season.
    """
    ...
    def new_game_view(self):
        ...
        layout = [
            [
                sg.Text(
                    f"New Game:\n{self.season} " + f"{self.league_id} season",
                    font="Arial 24",
